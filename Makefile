...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/Pwpp.Pedalog.make \
	$(srcdir)/pwpp.pedalog.pc.in $(top_srcdir)/Makefile.include \
...
CONFIG_CLEAN_FILES = pwpp.pedalog.pc
...
ACLOCAL = ${SHELL} /home/dan/pedalog/libpedalog-mono/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/dan/pedalog/libpedalog-mono/missing --run tar
AUTOCONF = ${SHELL} /home/dan/pedalog/libpedalog-mono/missing --run autoconf
AUTOHEADER = ${SHELL} /home/dan/pedalog/libpedalog-mono/missing --run autoheader
...
STRIP = 
VERSION = 0.1
abs_builddir = /home/dan/pedalog/libpedalog-mono
abs_srcdir = /home/dan/pedalog/libpedalog-mono
abs_top_builddir = /home/dan/pedalog/libpedalog-mono
abs_top_srcdir = /home/dan/pedalog/libpedalog-mono
am__leading_dot = .
...
install_sh = ${SHELL} /home/dan/pedalog/libpedalog-mono/install-sh
...
am--refresh:
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/Pwpp.Pedalog.make $(top_srcdir)/Makefile.include $(am__configure_deps)
	@for dep in $?; do \
...
$(am__aclocal_m4_deps):
pwpp.pedalog.pc: $(top_builddir)/config.status $(srcdir)/pwpp.pedalog.pc.in
